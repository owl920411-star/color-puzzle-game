...
(async()=>{
 ...
 try{
  ...
  check('photo download is a valid PNG with the expected filename',download.suggestedFilename()==='farm-friends-garden.png'&&bytes.subarray(0,8).equals(Buffer.from([137,80,78,71,13,10,26,10])));
