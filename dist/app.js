...
const materials={glass:{name:'유리',tag:'균열을 잇는 설계',rule:'가로줄을 채우면 연결된 흰 균열까지 파쇄됩니다.',effect:'파쇄'},sand:{name:'모래',tag:'형태보다 흐름을 설계하는 퍼즐',rule:'공중에서는 하나의 모래 덩어리로 조작하고, 착지하면 형태가 풀려 낮은 곳으로 쏟아집니다. 같은 색 모래를 모아 SAND BURST와 산사태 연쇄를 만드세요.',effect:'SAND BURST'}};
const materialColors={sand:[['#e6c47b','#8d5d28'],['#b99ac9','#705b7c'],['#91aab0','#4f686f']]};
...
function tone(kind,n=1){
 ...
 const profile={glass:{base:740,type:'sine',tail:.32},sand:{base:180,type:'triangle',tail:.14}}[game.material];
