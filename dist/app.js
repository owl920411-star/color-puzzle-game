...
const materials={glass:{name:'유리',tag:'균열을 잇는 설계',rule:'가로줄을 채우면 연결된 흰 균열까지 파쇄됩니다.',effect:'파쇄'},sand:{name:'모래',tag:'산사태를 설계하는 퍼즐',rule:'같은 색 모래 10칸을 연결하면 붕괴합니다. 빈틈으로 흐른 모래가 다시 10칸을 만들면 연쇄 붕괴!',effect:'SAND BURST'},water:{name:'물',tag:'빈틈을 찾아 흐르는 물',rule:'같은 색 물 10칸 이상을 상하좌우로 모으면 배수됩니다.',effect:'배수'},jelly:{name:'젤리',tag:'붙을수록 커지는 탄성',rule:'같은 색 젤리 8칸 이상이 상하좌우로 붙으면 터집니다.',effect:'팝'}};
